...
namespace Notificaciones
{
    ...
    public class Notificacion
    {
        ...
        //Iconos
        public static Image OK { get; set; } = Properties.Resources.icons8_ok_64px;
        public static Image WARNING { get; set; } = Properties.Resources.icons8_warning_64px;
        public static Image ERROR { get; set; } = Properties.Resources.icons8_error_64px;
        public static Image INFO { get; set; } = Properties.Resources.icons8_info_64px;
        /// <summary>
        ...
        /// <param name="tipo">Tipo de icono que se va a mostrar, existen Notificacion.OK, Notificacion.WARNING, Notificacion.ERROR, Notificacion.INFO, Notificacion.CUSTOM_ICON </param>
